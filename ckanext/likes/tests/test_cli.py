"""Tests for ckanext.likes.cli module.
...
import ckanext.likes.cli as commands
...
class TestCountUsers:
    ...
    def test_output(self, cli: CliRunner, faker: Faker, user_factory: Any):
        ...
        result = cli.invoke(commands.likes, ["count-users"])
